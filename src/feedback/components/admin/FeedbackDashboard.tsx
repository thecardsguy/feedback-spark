...
const styles: Record<string, React.CSSProperties> = {
  ...
  exportPromptsButton: {
    ...
    gap: 6,
    padding: '8px 12px',
    border: '1px solid var(--primary, hsl(262.1 83.3% 57.8%))',
    borderRadius: 6,
    backgroundColor: 'var(--primary, hsl(262.1 83.3% 57.8%))',
    cursor: 'pointer',
  ...
  tabsContainer: {
    display: 'flex',
    gap: 8,
    borderBottom: '1px solid var(--border, hsl(214.3 31.8% 91.4%))',
    paddingBottom: 0,
  },
  tab: {
    display: 'flex',
  ...
  tabActive: {
    color: 'var(--primary, hsl(262.1 83.3% 57.8%))',
    borderBottomColor: 'var(--primary, hsl(262.1 83.3% 57.8%))',
  },
  tabBadge: {
    padding: '2px 8px',
    borderRadius: 10,
    backgroundColor: 'var(--muted, hsl(210 40% 96.1%))',
    color: 'var(--muted-foreground, hsl(215.4 16.3% 46.9%))',
    fontSize: 12,
    fontWeight: 600,
  },
  tabBadgeAI: {
    backgroundColor: 'var(--accent, hsl(210 40% 96.1%))',
  ...
  clearButton: {
    ...
    fontSize: 13,
    color: 'var(--primary, hsl(262.1 83.3% 57.8%))',
    backgroundColor: 'var(--primary, hsl(262.1 83.3% 57.8%))/0.1',
    cursor: 'pointer',
  },
  content: {
    display: 'grid',
  ...
  emptyState: {
    ...
    backgroundColor: 'var(--accent, hsl(210 40% 96.1%))',
    borderRadius: 12,
    border: '1px dashed var(--border, hsl(214.3 31.8% 91.4%))',
  },
  emptyTitle: {
    margin: '16px 0 8px',
    fontSize: 18,
